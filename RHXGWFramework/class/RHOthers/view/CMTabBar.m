...
- (void)layoutSubviews {
    ...
    for (CMTabBarItem *item in [self items]) {
...
- (void)setItems:(NSArray *)items {
    for (CMTabBarItem *item in items) {
...
- (void)setSelectedItem:(CMTabBarItem *)selectedItem {
    ...
    if ([[self delegate] respondsToSelector:@selector(tabBar:didSelectItemAtIndex:)]) {
        NSInteger index = [self.items indexOfObject:_selectedItem];
